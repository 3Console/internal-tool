                ...
                <data-table :get-data="getPendingRequest" ref="datatable">
                  ...
                  <template slot="body" slot-scope="{ item }">
                    <tr>
                      ...
                      <td class="text-center" v-html="item.title" @click="toAbsenceDetail(item.request_id)" style="cursor: pointer"></td>
  ...
  export default {
    ...
    methods: {
      ...
      getPendingRequest (params) {
        ...
        return rf.getRequest('UserAbsenceRequest').getUserAbsenceRequests(meta);
      },
